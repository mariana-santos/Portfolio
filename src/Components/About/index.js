    ...
    return (
        <section className='container' id='about'>
            <div className='column text' data-aos="fade-right">
                ...
                <p className='smaller show-up'>Apaixonada por criação e tecnologia. <br/></p>
                <p className='smaller show-up'>Ampla experiência em <strong>desenvolvimento de aplicações web e mobile </strong>responsivas e acessíveis.</p>
