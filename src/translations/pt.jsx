export const pt = {
  ...
  projects: {
    refinances: {
      ...
      description:
        '<p>O <strong>Refinances</strong> nasceu de uma necessidade observada pelo grupo: a organizacao financeira. O projeto foi desenvolvido como nosso <strong>Trabalho de Conclusao de Curso</strong> na <a href="https://www.fiap.com.br/" target="_blank" rel="noreferrer">ETEC de Guaianazes</a>.</p><p>O app conta com o gerenciamento completo das financas: entradas, saidas, contas, metas financeiras e possui uma dashboard para acompanhar os gastos por categoria.</p>',
    },
    dzero: {
      subtitle: "Biblioteca de componentes internos",
      description:
        '<p>Um grande problema em diversos times de desenvolvimento e a falta de padronizacao no codigo e no design em diferentes projetos. O DZERO e uma <strong>biblioteca de componentes</strong> internos desenvolvida para padronizar a interface do usuario em projetos da empresa.</p><p>Nele estruturamos um template para cada projeto futuro da empresa, criando padroes de dados e opcoes de interfaces <strong>robustas e customizaveis.</strong> Utilizamos a metodologia <a href="https://atomicdesign.bradfrost.com/chapter-2/" target="_blank" rel="noreferrer">Atomic Design</a> como base de estrutura da biblioteca.</p>',
    },
    investium: {
      subtitle: "Website criado para facilitar e incentivar o investimento em IPO",
      description:
        '<p>A <a href="https://www.fiap.com.br/" target="_blank" rel="noreferrer">FIAP</a> em parceria com a <a href="https://www.b3.com.br/pt_br/" target="_blank" rel="noreferrer">B3</a> nos desafiou a usar a tecnologia para desmistificar o investimento em <strong>IPO</strong> no Brasil.</p><p>Pensando nisso, a <strong>Investium</strong> foi criada. Uma solucao para investidores iniciantes que nao possuem acesso facil as informacoes das IPOs, com funcionalidades como comparacao de IPOs e graficos detalhados sobre as informacoes financeiras das empresas.</p>',
      summary_description:
        "<p>A <strong>Investium</strong> foi criada para desmistificar o investimento em <strong>IPO</strong> no Brasil, com funcionalidades como comparacao de IPOs e graficos detalhados sobre as informacoes financeiras das empresas. O projeto foi desenvolvido com <strong>React</strong> e <strong>Javascript</strong>.</p>",
    },
    "raizes-solidarias": {
      subtitle:
        "Website criado para gerenciar uma ficticia horta solidaria contra a fome",
      description:
        '<p>A <a href="https://www.fiap.com.br/" target="_blank" rel="noreferrer">FIAP</a> nos propos encontrar uma forma de utilizar tecnologia e inovacao no problema da <strong>fome</strong>. Com isso em mente, desenvolvemos a <strong>Raizes Solidarias</strong> como um projeto de horta urbana comunitaria.</p><p>Os usuarios podem ser voluntarios diretos e tambem podem doar e gerenciar a horta de forma <strong>gamificada</strong>. O valor doado e convertido em moedas virtuais para serem utilizadas na compra de sementes, adubo e fertilizantes.</p>',
    },
    "valorant-web": {
      subtitle: "Website com informacoes do jogo Valorant",
      description:
        '<p>O projeto foi criado em parceria com o <strong>Alexandre</strong>, que e um grande fa do jogo e me chamou para ajuda-lo a utilizar a <a href="https://valorant-api.com/">API da Riot Games</a> para criar um sistema web com informacoes sobre o game.</p><p>Alem de um gerador de banner personalizavel e compartilhavel, no site e possivel encontrar as principais informacoes do jogo, como agentes, mapas e armas.</p>',
    },
    "alura-studies": {
      subtitle: "Website para gerenciamento de estudos",
      description:
        '<p>O projeto foi criado junto ao curso <strong>"React: escrevendo com Typescript"</strong> da <a href="https://www.alura.com.br/" target="_blank" rel="noreferrer">Alura</a>, uma plataforma de cursos de tecnologia.</p><p>Com ele aprendi mais sobre Typescript, CSS modules, Hooks no React e boas praticas como <strong>DRY (Don\'t repeat yourself) e SRP (Single Responsibility Principle).</strong></p>',
    },
    solar: {
      subtitle: "Website de aluguel de carros eletricos",
      description:
        '<p>A <a href="https://www.fiap.com.br/" target="_blank" rel="noreferrer">FIAP</a> nos desafiou a usar a tecnologia para melhorar a mobilidade urbana no Brasil.</p><p>Pensando nisso, criamos o Solar, uma solucao baseada no desenvolvimento de um website de <strong>aluguel de carros eletricos movidos a energia solar</strong>, visando a popularizacao do carro eletrico, sustentabilidade, otimizacao do transito, preservacao da fauna e flora e reducao da quantidade de carros parados.</p>',
    },
    "nutri-tips": {
      subtitle: "Blog de nutricao consumindo uma API externa",
      description:
        '<p>Durante o inicio dos meus estudos com <strong>React</strong>, construi esse projeto simples de um blog sobre nutricao com filtros.</p><p>Os dados sao consumidos da API disponibilizada gratuitamente pelo <a href="https://sujeitoprogramador.com/rn-api/?api=posts" target="_blank" rel="noreferrer">Sujeito Programador</a>.</p>',
    },
    bagify: {
      subtitle: "Aplicativo de gerenciamento de bagagens",
      description:
        '<p>Durante o <strong>Hackaton</strong> promovido pela <a href="https://www.copastur.com.br/" target="_blank" rel="noreferrer">Copastur</a> e a <a href="https://www.fiap.com.br/" target="_blank" rel="noreferrer">FIAP</a>, fomos desafiados a encontrar uma forma de humanizar a experiencia dos viajantes de companhias aereas.</p><p>Desse problema surgiu o <strong>Bagify</strong>: um app de gerenciamento para o usuario ter controle de suas bagagens enquanto viaja, e assim viajar sem preocupacoes com a seguranca de seus pertences.</p>',
    },
  },
